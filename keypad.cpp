...
const Keypad::KeyDescription Keypad::keyDescriptions[] = {
    ...
    {QString::fromLatin1("ans"), KeyAns, false, 3, 5}, //1,6
    ...
    {QString::fromLatin1("BS"), KeyBS, false, 0, 5},
    {QString::fromLatin1("ln"), KeyLn, false, 0, 8},
    {QString::fromLatin1("("), KeyLeftPar, false, 2, 4},
    {QString::fromLatin1("lg"), KeyLg, false, 0, 6}, //3,4
    ...
    {QString::fromUtf8("π"), KeyPi, false, 3, 4}, //0,6
    {QString::fromUtf8("√"), KeySqrt, false, 1, 6} //3,5
};
